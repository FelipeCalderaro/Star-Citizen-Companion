...
class WindowControl {
  ...
  final String title = "Star Citizen Companion";
  ...
  Future<void> startUp() async {
    ...
    screenHeight = GetSystemMetrics(SYSTEM_METRICS_INDEX.SM_CXVIRTUALSCREEN);
    screenWidth = GetSystemMetrics(SYSTEM_METRICS_INDEX.SM_CYVIRTUALSCREEN);
